<script setup>
  ...
  const messages = ["Un essai pour résoudre le jour 25 de l'Advent of Code 2015 avec Github Copilot"]
</script>
...
<template>
    ...
    <main>
        ...
        <input v-model="row" type="number" placeholder="Row">
        <input v-model="column" type="number" placeholder="Column">
        <button @click="solve">Solve</button>
        <p>Code: <span v-if="code !== null">{{ code }}</span></p>
    </main>
...
<script>
    ...
    export default {
        ...
        methods: {
            solve() {
                const position = this.getPosition(this.row, this.column);
                this.code = this.getCode(position);
            },
